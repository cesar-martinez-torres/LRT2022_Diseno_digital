...
entity ejercicio02_tb is
end entity ejercicio02_tb;

architecture sim of ejercicio02_tb is
  component ejercicio02 is
    port (a : in std_logic; b : in std_logic; c : in std_logic; y : out std_logic);
  end component ejercicio02;
  signal a : std_logic := '0';
  signal b : std_logic := '0';
  signal c : std_logic := '0';
  signal y : std_logic;
begin
  dut : ejercicio02 port map (a => a, b => b, c => c, y => y);
  stimulus : process
  begin
