...
entity ejercicio09_tb is
end entity ejercicio09_tb;

architecture sim of ejercicio09_tb is
  component ejercicio09 is
    port (a, b, c, d : in std_logic; y : out std_logic);
  end component ejercicio09;
  ...
  signal y : std_logic;
begin
  dut : ejercicio09 port map (a => a, b => b, c => c, d => d, y => y);
  stimulus : process
  begin
    a <= '0'; b <= '0'; c <= '0'; d <= '0'; wait for 10 ns;
    assert y = '0' report "Error para a=0, b=0, c=0, d=0" severity error;
    a <= '0'; b <= '0'; c <= '0'; d <= '1'; wait for 10 ns;
    assert y = '0' report "Error para a=0, b=0, c=0, d=1" severity error;
    a <= '0'; b <= '0'; c <= '1'; d <= '0'; wait for 10 ns;
    assert y = '0' report "Error para a=0, b=0, c=1, d=0" severity error;
    ...
    assert y = '1' report "Error para a=1, b=1, c=1, d=0" severity error;
