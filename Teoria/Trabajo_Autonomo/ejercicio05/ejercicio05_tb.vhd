...
entity ejercicio05_tb is
end entity ejercicio05_tb;

architecture sim of ejercicio05_tb is
  component ejercicio05 is
    port (a, b, c : in std_logic; y : out std_logic);
  end component ejercicio05;
  signal a : std_logic := '0';
  signal b : std_logic := '0';
  signal c : std_logic := '0';
  signal y : std_logic;
begin
  dut : ejercicio05 port map (a => a, b => b, c => c, y => y);
  stimulus : process
  begin
